<!-- attempt-template session-key=subject-1-rag-nlp-drill session-version=3f533f502049 -->
# 科目 1 加練｜RAG 與進階 NLP｜作答單
...
- 題庫版本：`3f533f502049`
- 題目：[subject-1-rag-nlp-drill.md](../extended/subject-1-rag-nlp-drill.md)
- 報告：[subject-1-rag-nlp-drill-report.md](../reports/subject-1-rag-nlp-drill-report.md)
