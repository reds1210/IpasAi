<!-- attempt-template session-key=subject-2-timeseries-graph-drill session-version=b44fe4a6dcd4 -->
# 科目 2 加練｜時間序列與圖分析｜作答單
...
- 題庫版本：`b44fe4a6dcd4`
- 題目：[subject-2-timeseries-graph-drill.md](../extended/subject-2-timeseries-graph-drill.md)
- 報告：[subject-2-timeseries-graph-drill-report.md](../reports/subject-2-timeseries-graph-drill-report.md)
