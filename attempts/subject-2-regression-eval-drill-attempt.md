<!-- attempt-template session-key=subject-2-regression-eval-drill session-version=71a955cbb144 -->
# 科目 2 加練｜回歸與評估補強｜作答單
...
- 題庫版本：`71a955cbb144`
- 題目：[subject-2-regression-eval-drill.md](../extended/subject-2-regression-eval-drill.md)
- 報告：[subject-2-regression-eval-drill-report.md](../reports/subject-2-regression-eval-drill-report.md)
