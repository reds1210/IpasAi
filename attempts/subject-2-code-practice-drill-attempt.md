<!-- attempt-template session-key=subject-2-code-practice-drill session-version=a8c64594da8e -->
# 科目 2 加練｜程式碼題型｜作答單
...
- 題庫版本：`a8c64594da8e`
- 題目：[subject-2-code-practice-drill.md](../extended/subject-2-code-practice-drill.md)
- 報告：[subject-2-code-practice-drill-report.md](../reports/subject-2-code-practice-drill-report.md)
